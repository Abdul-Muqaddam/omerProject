            ...
            <div className="flex items-center justify-center h-[15vh]">
                ...
                <div className="w-[120%] text-white h-[56px] rounded-[20px] bg-white bg-opacity-5 flex items-center justify-around ">
                    ...
                    <ul className="flex justify-between w-[26vw]">
                        <li className="flex items-center cursor-pointer group relative w-[6vw]">
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-0 group-hover:opacity-100 duration-300 transition-all ease-in-out"/>
                            <div className="text-[#BAD7F5] absolute group-hover:left-4 left-0 transition-all duration-300 ease-in-out">About us</div>
                        ...
                        <li className="flex items-center cursor-pointer group relative w-[4.7vw]">
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-0 group-hover:opacity-100 duration-300 transition-all ease-in-out"/>
                            <div className="text-[#BAD7F5] absolute group-hover:left-4 left-0 transition-all duration-300 ease-in-out">Stacks</div>
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-100 group-hover:opacity-0 transition-all duration-300 ease-in-out absolute right-0"/>
                        </li>
                        <li className="flex items-center cursor-pointer group relative w-[8vw]">
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-0 group-hover:opacity-100 duration-300 transition-all ease-in-out"/>
                            <div className="text-[#BAD7F5] absolute group-hover:left-4 left-0 transition-all duration-300 ease-in-out">Case Studies</div>
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-100 group-hover:opacity-0 transition-all duration-300 ease-in-out absolute right-0"/>
                        </li>
                        <li className="flex items-center cursor-pointer group relative w-[4vw]">
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-0 group-hover:opacity-100 duration-300 transition-all ease-in-out"/>
                            <div className="text-[#BAD7F5] absolute group-hover:left-4 left-0 transition-all duration-300 ease-in-out">Docs</div>
                            <img src="/arrow.png" alt="" className="h-[16px] w-[16px] opacity-100 group-hover:opacity-0 transition-all duration-300 ease-in-out absolute right-0"/>
                        </li>
